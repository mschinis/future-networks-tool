...
Private Sub ContinueBtn_Click()
    ...
    ChooseNetwork.Hide
    SetupSheets.setupAll
    Start.finished = True
    Preset_Network
    updateLastSimulationSheet
End Sub

Private Sub updateLastSimulationSheet()
    Dim Worksheet As Worksheet
    Set Worksheet = Sheets("LastSimulationData")
    
    Worksheet.Range("B2").Value = SharedClass.Settings.customers
    Worksheet.Range("B3").Value = SharedClass.Settings.feeders
    Worksheet.Range("B4").Value = SharedClass.Settings.laterals
End Sub
...
Private Sub SelectNetwork_Change()
    ...
    Assign_Profiles.NoLaterals = SharedClass.Settings.laterals
    Assign_Profiles.NoFeeders = SharedClass.Settings.feeders
    
    ReDim Assign_Profiles.PVPenetrationArray(1 To SharedClass.Settings.feeders, 1 To SharedClass.Settings.laterals)
    ReDim Assign_Profiles.EVPenetrationArray(1 To SharedClass.Settings.feeders, 1 To SharedClass.Settings.laterals)
    ReDim Assign_Profiles.HPPenetrationArray(1 To SharedClass.Settings.feeders, 1 To SharedClass.Settings.laterals)
    ReDim Assign_Profiles.CHPPenetrationArray(1 To SharedClass.Settings.feeders, 1 To SharedClass.Settings.laterals)
    
    If SelectNetwork.Value = "Urban" Or SelectNetwork.Value = "SemiUrban" Or SelectNetwork.Value = "Rural" Then
            Assign_Profiles.LateralSizes = PresetLateralSizes()
    Else
        Assign_Profiles.LateralSizes = CustomersPerLateralPerFeeder(SharedClass.Settings.customers, SharedClass.Settings.feeders, SharedClass.Settings.laterals)
    End If
    ...
    With LateralsBox
        For i = 1 To SharedClass.Settings.laterals
            .AddItem i
        Next
